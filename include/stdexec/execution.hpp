...
namespace stdexec {
  ...
  extern const forwarding_sender_query_t forwarding_sender_query;
  ...
  namespace __general_queries {
    struct get_domain_t {
      ...
      friend constexpr bool tag_invoke(forwarding_sender_query_t, get_domain_t) noexcept {
        return true;
      }
    };

    struct __get_domain_with_fallback_t {
      template <__none_of<no_env> _Ty, class _Fallback>
          requires tag_invocable<get_domain_t, const _Ty&> ||
            __callable<_Fallback, const _Ty&>
  ...
  using __general_queries::__get_domain_with_fallback_t;
  inline constexpr get_domain_t get_domain{};
  inline constexpr __get_domain_with_fallback_t __get_domain_with_fallback{};

  namespace __attrs { struct get_attrs_t; }
  using __attrs::get_attrs_t;
  template <class _Sender>
    using attrs_of_t = __call_result_t<get_attrs_t, _Sender>;

  template <class _Ty, class _Tag = __none_such>
    using domain_of_t =
      __call_result_t<get_domain_t, _Ty, _Tag>;

  template <class _Ty, class _Fallback>
    using __domain_of_or_t =
      __call_result_t<__get_domain_with_fallback_t, _Ty, _Fallback>;

  template <class _Ty, class _Tag = set_value_t>
    using __sender_domain_t =
      __domain_of_or_t<attrs_of_t<_Ty>, get_completion_scheduler_t<_Tag>>;

  template <class _Env, class _Sender>
    using __env_domain_t =
      __minvoke<
        __if_c<
          __valid<domain_of_t, _Sender>,
          __mbind_back_q<domain_of_t, _Sender>,
          __with_default<
            __mbind_back_q<__domain_of_or_t, _Env, get_scheduler_t>,
            __default_domain>>>;
  ...
  namespace __sender_queries {
    template <class _Tag>
      constexpr bool forwarding_sender_query_t::operator()(_Tag __tag) const noexcept {
  ...
  namespace __then {
    ...
    struct then_t {
      ...
      template <sender _Sender, __movable_value _Fun>
        requires
          (!__tag_invocable_with_domain<then_t, set_value_t, _Sender, _Fun>) &&
      ...
      sender auto operator()(_Sender&& __sndr, _Fun __fun) const
        noexcept(nothrow_tag_invocable<then_t, __sender_domain_t<_Sender, set_value_t>, _Sender, _Fun>) {
        auto __domain = __get_domain_with_fallback_t{}(get_attrs(__sndr), get_completion_scheduler<set_value_t>);
  ...
  namespace __upon_error {
    ...
    struct upon_error_t {
      ...
      sender auto operator()(_Sender&& __sndr, _Fun __fun) const
        noexcept(nothrow_tag_invocable<upon_error_t, __sender_domain_t<_Sender, set_error_t>, _Sender, _Fun>) {
        auto __domain = __get_domain_with_fallback_t{}(get_attrs(__sndr), get_completion_scheduler<set_error_t>); // TODO ADD TEST!
      ...
      template <sender _Sender, __movable_value _Fun>
        requires
          (!__tag_invocable_with_domain<upon_error_t, set_error_t, _Sender, _Fun>) &&
          (!tag_invocable<upon_error_t, _Sender, _Fun>) &&
          sender<__sender<_Sender, _Fun>>
      __sender<_Sender, _Fun> operator()(_Sender&& __sndr, _Fun __fun) const {
        return __sender<_Sender, _Fun>{(_Sender&&) __sndr, (_Fun&&) __fun};
  ...
  namespace __upon_stopped {
    ...
    struct upon_stopped_t {
      ...
      template <sender _Sender, __movable_value _Fun>
        requires
          __tag_invocable_with_domain<upon_stopped_t, set_stopped_t, _Sender, _Fun> &&
          __callable<_Fun>
      sender auto operator()(_Sender&& __sndr, _Fun __fun) const
        noexcept(nothrow_tag_invocable<upon_stopped_t, __sender_domain_t<_Sender, set_stopped_t>, _Sender, _Fun>) {
        auto __domain = __get_domain_with_fallback_t{}(get_attrs(__sndr), get_completion_scheduler<set_stopped_t>); // TODO ADD TEST!
        return tag_invoke(upon_stopped_t{}, std::move(__domain), (_Sender&&) __sndr, (_Fun&&) __fun);
      }
      template <sender _Sender, __movable_value _Fun>
  ...
  namespace __bulk {
    ...
    struct bulk_t {
      ...
      sender auto operator()(_Sender&& __sndr, _Shape __shape, _Fun __fun) const
        noexcept(nothrow_tag_invocable<bulk_t, __sender_domain_t<_Sender, set_value_t>, _Sender, _Shape, _Fun>) {
        auto __domain = __get_domain_with_fallback_t{}(get_attrs(__sndr), get_completion_scheduler<set_value_t>);
        return tag_invoke(bulk_t{}, std::move(__domain), (_Sender&&) __sndr, (_Shape&&) __shape, (_Fun&&) __fun);
      }
      template <sender _Sender, integral _Shape, __movable_value _Fun>
        requires (!__tag_invocable_with_domain<bulk_t, set_value_t, _Sender, _Shape, _Fun>) &&
      ...
      template <sender _Sender, integral _Shape, __movable_value _Fun>
        requires
           (!__tag_invocable_with_domain<bulk_t, set_value_t, _Sender, _Shape, _Fun>) &&
           (!tag_invocable<bulk_t, _Sender, _Shape, _Fun>)
  ...
  namespace __let {
    ...
    template <class _LetTag, class _SetTag>
      struct __let_xxx_t {
        ...
        sender auto operator()(_Sender&& __sndr, _Fun __fun) const
          noexcept(nothrow_tag_invocable<_LetTag, __sender_domain_t<_Sender, set_value_t>, _Sender, _Fun>) {
          auto __domain = __get_domain_with_fallback_t{}(get_attrs(__sndr), get_completion_scheduler<set_value_t>);
  ...
  namespace __transfer {
    struct transfer_t {
      ...
      operator()(_Sender&& __sndr, _Scheduler&& __sched) const
        noexcept(nothrow_tag_invocable<transfer_t, __sender_domain_t<_Sender, set_value_t>, _Sender, _Scheduler>) {
        auto __domain = __get_domain_with_fallback_t{}(get_attrs(__sndr), get_completion_scheduler<set_value_t>);
        return tag_invoke(transfer_t{}, std::move(__domain), (_Sender&&) __sndr, (_Scheduler&&) __sched);
      }
      template <sender _Sender, scheduler _Scheduler>
        requires (!__tag_invocable_with_domain<transfer_t, set_value_t, _Sender, _Scheduler>) &&
  ...
  namespace __sync_wait {
    ...
    struct sync_wait_with_variant_t {
      ...
      operator()(_Sender&& __sndr) const noexcept(
        ...
        auto __domain =
          __get_domain_with_fallback_t{}(get_attrs(__sndr), get_completion_scheduler<set_value_t>);
        return tag_invoke(
          sync_wait_with_variant_t{}, std::move(__domain), (_Sender&&) __sndr);
      }
      template <sender<__env> _Sender>
        requires
          (!__tag_invocable_with_domain<
